...
@Component({
  selector: 'app-facilities-dose-two',
  templateUrl: './facilities-dose-two.component.html',
  styleUrls: ['./facilities-dose-two.component.scss']
})
export class FacilitiesDoseTwoComponent implements OnInit {
  ...
  onUpdateForm(dose: DoseFormData) {  
    this.router.navigateByUrl(`/${AppRoutes.FACILITIES}/${AppRoutes.DOSE_TWO}/${AppRoutes.FACILITY_USER_VAC}`, { state: { from : AppRoutes.DOSE_TWO, patientId: dose.patientId._id, facilityId: dose.facilityId}});
    // this.router.navigate([AppRoutes.ROOT,AppRoutes.USER_VAC]);
  }

  onAddDose(dose: DoseFormData) {
    
    this.router.navigateByUrl(`/${AppRoutes.FACILITIES}/${AppRoutes.DOSE_TWO}/${AppRoutes.FACILITY_ADD_OTH_DOSE}`, { state: { fromWhere : AppRoutes.DOSE_TWO, patientId: dose.patientId._id, facilityId: dose.facilityId}  });
  }

  onDoseHistory(dose: DoseFormData) {
    this.router.navigateByUrl(`/${AppRoutes.FACILITIES}/${AppRoutes.DOSE_TWO}/${AppRoutes.FACILITY_DOSE_HISTORY}`, { state: { fromWhere : AppRoutes.DOSE_TWO, patientId: dose.patientId._id, facilityId: dose.facilityId}  });

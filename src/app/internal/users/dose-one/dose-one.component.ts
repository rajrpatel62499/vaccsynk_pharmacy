...
@Component({
  selector: 'app-dose-one',
  templateUrl: './dose-one.component.html',
  styleUrls: ['./dose-one.component.scss']
})
export class DoseOneComponent implements OnInit {
  ...
  onUpdateForm(dose: DoseFormData) {  
    this.router.navigateByUrl(`/${AppRoutes.USERS}/${AppRoutes.DOSE_ONE}/${AppRoutes.USER_VAC}`, { state: { from : AppRoutes.DOSE_ONE, patientId: dose.patientId._id}});
    // this.router.navigate([AppRoutes.ROOT,AppRoutes.USER_VAC]);
  }

  onAddDose(dose: DoseFormData) {
    
    this.router.navigateByUrl(`/${AppRoutes.USERS}/${AppRoutes.DOSE_ONE}/${AppRoutes.ADD_OTH_DOSE}`,
     { state: { fromWhere : AppRoutes.DOSE_ONE, patientId: dose.patientId._id, patientNumber: dose.patientNumber}  });
  }

  onDoseHistory(dose: DoseFormData) {
    this.router.navigateByUrl(`/${AppRoutes.USERS}/${AppRoutes.DOSE_ONE}/${AppRoutes.DOSE_HISTORY}`, { state: { fromWhere : AppRoutes.DOSE_ONE, patientId: dose.patientId._id}  });
